...
#define DFMOCO_VERSION_STRING "1.2.5"

/*
  DFMoco version 1.2.5
...
// setup step and direction pins
  ...
  /*   Commented out original pin mapping.  
...
//Start TB3 Black Port Mapping
  ...
  #define MOTOR3_STEP_PORT PORTH //use the same port as MOTOR2 for now - commented out section where this is called
  #define MOTOR3_STEP_PIN  B00010000 //use the same port as MOTOR2 for now - commented out section where this is called
...
digitalWrite(MOTOR_EN_2, LOW); //Enable the motors 2 
  ...
  #elif (BOARD == ARDUINO) || (BOARD == ARDUINOMEGA)
